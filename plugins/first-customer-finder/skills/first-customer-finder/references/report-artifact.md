...
Return a clickable absolute file link so the user can open the report. Keep the JSON in a work or temporary directory unless the user asks for raw data.
